...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository, TransactionRepository transactionRepository, LoanRepository loanRepository, ClientLoanRepository clientLoanRepository, CardRepository cardRepository){
		return (args -> {
			...
			Account account1 = new Account("VIN-001",LocalDate.now(),5000.0,TypeAccount.CURRENT_ACCOUNT);

			//melba's second account
			Account account2 = new Account("VIN-002",LocalDate.now().plusDays(1),7500.0,TypeAccount.SAVING_ACCOUNT);

			//javier's account
			Account account3 = new Account("VIN-003",LocalDate.now().plusDays(5),75000.0,TypeAccount.SAVING_ACCOUNT);
